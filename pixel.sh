git clone https://github.com/BirdSanctuary/device_xiaomi_kenzo -b oreo-mr1 device/xiaomi/kenzo
git clone https://github.com/BirdSanctuary/device_xiaomi_msm8956-common -b oreo-mr1 device/xiaomi/msm8956-common
git clone https://github.com/BirdSanctuary/kernel_xiaomi_msm8956 -b oreo-mr1 kernel/xiaomi/msm8956
git clone https://github.com/irvin016/proprietary_vendor_xiaomi -b oreo-mr1 vendor/xiaomi
...
rm -r cardinal.mk
rm -r cardinal.dependencies
rm -r vendorsetup.sh
git clone https://gist.github.com/irvin016/f05d3b7a069bb175f97ee25e8c8dd92b
cd ..
cd msm8956-common
rm -r cardinal.dependencies
cd ..
